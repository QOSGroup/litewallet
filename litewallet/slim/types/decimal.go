...
func (d Dec) MulInt(i btypes.BigInt) Dec {
	mul := new(big.Int).Mul(d.Int, i.BigInt())
...
func (d Dec) QuoInt(i btypes.BigInt) Dec {
	mul := new(big.Int).Quo(d.Int, i.BigInt())
	return Dec{mul}
}
...
func (d Dec) RoundInt() btypes.BigInt {
	return btypes.NewIntFromBigInt(chopPrecisionAndRoundNonMutative(d.Int))
}
...
func (d Dec) TruncateInt() btypes.BigInt {
	return btypes.NewIntFromBigInt(chopPrecisionAndTruncateNonMutative(d.Int))
}
